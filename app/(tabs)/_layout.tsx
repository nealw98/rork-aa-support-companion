...
import { Home, MessageCircle, Book, Heart, Moon, Lightbulb, Smile } from "lucide-react-native";
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color }) => <Lightbulb color={color} size={22} style={styles.tabIcon} />,
        }}
      />
    </Tabs>
  );
