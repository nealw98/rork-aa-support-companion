    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => router.push('/(tabs)/reflection' as any)}
        >
        ...
        <TouchableOpacity style={styles.card} onPress={() => router.push('/(tabs)/prayers' as any)}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => router.push('/(tabs)/reflection' as any)}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => router.push('/(tabs)/literature' as any)}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => router.push('/(tabs)/gratitude' as any)}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => router.push('/(tabs)/chat' as any)}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => router.push('/(tabs)/insights' as any)}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => router.push('/(tabs)/nightly-review' as any)}>
